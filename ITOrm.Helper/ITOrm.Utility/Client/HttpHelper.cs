...
namespace ITOrm.Utility.Client
{
    ...
    public class HttpHelper
    {
        ...
        public static int HttpPostData(string url, Encoding encoding,
                                    string[] filePath, string[] fileKeyName, NameValueCollection stringDict, out string result)
            {
            ...
            try
            {
                ...
                for (int i = 0; i < filePath.Length; i++)
                {
                    ...
                    var header = string.Format(filePartHeader, fileKeyName[i], filePath);
