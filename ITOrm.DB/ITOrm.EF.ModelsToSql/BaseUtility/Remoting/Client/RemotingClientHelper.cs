...
namespace ITOrm.EF.Models.Remoting
{
    /// <summary>
    ...
    {
        public static readonly RCHelper Instance = new RCHelper();
        private RCHelper()
        {
        ...
        /// <returns></returns>
        public T GetWellKnownObject<T>(string hostUrl,string objectUri)
        {
        ...
        public T GetWellKnownObject<T>()
        {
            ...
            return GetWellKnownObject<T>(clientName);
        }
        ...
        /// <param name="objectUri"></param>
        /// <returns></returns>
        public T GetRemoteObject<T>(string objectUri)
        {
            string hostUrl = HostManager.Instance.GetCurrentHostAddress();
            return GetWellKnownObject<T>(hostUrl, objectUri);
        }
    }
}
