...
namespace ITOrm.EF.Models.PagerWebdiyer
{
    public static class PagerHelper
    {
        ...
        /*
         * 调用方式
         @Html.Pager(Model, new PagerOptions { PageIndexParameterName = "pageIndex", CurrentPagerItemWrapperFormatString = "<span class=\"current\">{0}</span>", NumericPagerItemWrapperFormatString = "<span class=\"item\">{0}</span>", CssClass = "pages float-right", SeparatorHtml = "" })
         */
        ...
        /// <returns></returns>
        public static MvcHtmlString Pager(this HtmlHelper helper, DataTable pagedList, int TotalCount, int PageSize, int PageIndex, PagerOptions pagerOptions)
        {
            if (pagedList == null)
