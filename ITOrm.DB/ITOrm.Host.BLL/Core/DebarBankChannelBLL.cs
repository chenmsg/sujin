...
// <auto-generated>
//    此代码是根据模板生成的...
//    生成时间 2018-08-14 10:53:02 By CClump
...
namespace ITOrm.Host.BLL
{
    ...
    /// 备注
    /// </summary>
    public partial  class DebarBankChannelBLL
    {
		private readonly IDebarBankChannelDAL dal = ContainerHelper.Get<IDebarBankChannelDAL>();
	    #region ==========增删改数据
        ...
        public  int Insert(DebarBankChannel entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Update(DebarBankChannel entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Delete(DebarBankChannel entity)
        {
            return dal.Update(entity);
        }
