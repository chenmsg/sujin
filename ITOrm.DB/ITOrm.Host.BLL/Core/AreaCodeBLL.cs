...
namespace ITOrm.Host.BLL
{
    ...
    /// 备注
    /// </summary>
    public partial  class AreaCodeBLL
    {
		private readonly IAreaCodeDAL dal = ContainerHelper.Get<IAreaCodeDAL>();
	    #region ==========增删改数据
        ...
        public  int Insert(AreaCode entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Update(AreaCode entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Delete(AreaCode entity)
        {
            return dal.Update(entity);
        }
