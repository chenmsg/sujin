...
namespace ITOrm.Host.BLL
{
    ...
    /// 备注
    /// </summary>
    public partial  class AccountRecordBLL
    {
		private readonly IAccountRecordDAL dal = ContainerHelper.Get<IAccountRecordDAL>();
	    #region ==========增删改数据
        ...
        public  int Insert(AccountRecord entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Update(AccountRecord entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Delete(AccountRecord entity)
        {
            return dal.Update(entity);
        }
