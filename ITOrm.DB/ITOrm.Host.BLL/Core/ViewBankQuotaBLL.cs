...
namespace ITOrm.Host.BLL
{
    ...
    /// 备注
    /// </summary>
    public partial  class ViewBankQuotaBLL
    {
		private readonly IViewBankQuotaDAL dal = ContainerHelper.Get<IViewBankQuotaDAL>();
	    #region ==========查询单一实体
        ...
        /// <returns>ViewBankQuota实体对象</returns>
        public  ViewBankQuota Single(string where, object param = null)
        {
