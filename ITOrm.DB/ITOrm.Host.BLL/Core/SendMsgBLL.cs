...
namespace ITOrm.Host.BLL
{
    ...
    {
		private readonly ISendMsgDAL dal = ContainerHelper.Get<ISendMsgDAL>();
	    #region ==========增删改数据
        ...
        public  int Insert(SendMsg entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Update(SendMsg entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Delete(SendMsg entity)
        {
            return dal.Update(entity);
        }
