...
// <auto-generated>
//    此代码是根据模板生成的...
//    生成时间 2018-08-14 10:53:04 By CClump
...
namespace ITOrm.Host.BLL
{
    ...
    {
		private readonly IYeepayLogDAL dal = ContainerHelper.Get<IYeepayLogDAL>();
	    #region ==========增删改数据
        ...
        public  int Insert(YeepayLog entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Update(YeepayLog entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Delete(YeepayLog entity)
        {
            return dal.Update(entity);
        }
