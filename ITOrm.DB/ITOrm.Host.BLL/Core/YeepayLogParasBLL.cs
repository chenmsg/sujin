...
// <auto-generated>
//    此代码是根据模板生成的...
//    生成时间 2018-04-23 13:47:02 By CClump
...
namespace ITOrm.Host.BLL
{
    ...
    {
		private readonly IYeepayLogParasDAL dal = ContainerHelper.Get<IYeepayLogParasDAL>();
	    #region ==========增删改数据
        ...
        public  int Insert(YeepayLogParas entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Update(YeepayLogParas entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Delete(YeepayLogParas entity)
        {
            return dal.Update(entity);
        }
