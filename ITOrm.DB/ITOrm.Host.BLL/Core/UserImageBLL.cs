...
namespace ITOrm.Host.BLL
{
    ...
    {
		private readonly IUserImageDAL dal = ContainerHelper.Get<IUserImageDAL>();
	    #region ==========增删改数据
        ...
        public  int Insert(UserImage entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Update(UserImage entity)
        {
        ...
        /// </summary>
        /// <returns>返回,成功:true,失败:false</returns>
        public  bool Delete(UserImage entity)
        {
            return dal.Update(entity);
        }
