    ...
    internal class JsonBuilder
    {
                ...
                foreach (PropertyInfo pi in propertyInfos)
                {
                    ...
                    else
                    {
                        if (pi.CanRead)
                        {
                            ...
                            {
                                //builder.Append("\"" + DataHelper.FormatDateTime((DateTime)value) + "\"");//------------
                            }
        ...
        private static void BuildJsonArray(IEnumerable ie, List<string> excludePropertys, StringBuilder builder, ArrayList parsed)
        {
            ...
            while (ito.MoveNext())
            {
                ...
                {
                    //builder.Append("\"" + DataHelper.FormatDate((DateTime)ito.Current) + "\"");//------------
                }
        ...
        private static void BuildJson(object obj, List<string> excludePropertys, StringBuilder builder)
        {
            ...
            if (IsDateTime(obj))
            {
                //builder.Append("\"" + DataHelper.FormatDateTime((DateTime)obj) + "\"");
                return;
            }
            if (IsString(obj))
            {
