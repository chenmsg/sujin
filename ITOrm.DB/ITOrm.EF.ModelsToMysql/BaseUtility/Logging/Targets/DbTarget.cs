...
using ITOrm.Ms.Models.Logging.Formatters;
using ITOrm.Ms.Models.Helper;

namespace ITOrm.Ms.Models.Logging.Targets
{
    public class DbTarget : ITarget
    {
        public DbTarget(IFormatter formatter)
        {
            Util.ArgumentNotNull(formatter, "formatter");
            Formatter = formatter;
        }
        ...
        {
            Util.ArgumentNotNull(config, "config");
