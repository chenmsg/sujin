...
namespace AddUnitText
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string url = "http://pub.anxin.com/ajax/appchannel4/checkdistinct.aspx?appid=889056416&idfa=E7E59C96-B585-422E-878C-A15143B0CA11&source=weiyi";
            for (int i = 1; i <= 200; i++)
            {
                var result = HttpHelper.HttpGetHTML(url);
                Console.WriteLine($"第{i}次,返回结果:{result}");
                Thread.Sleep(100);
            }
            Console.ReadLine();
